...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Unigrid Core unigrid-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  unigrid-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded unigrid transaction") + "\n" +
                               "  unigrid-tx [options] -create [commands]   " + _("Create hex-encoded unigrid transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded unigrid transaction
