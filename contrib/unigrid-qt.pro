...
RESOURCES += src/qt/unigrid.qrc src/qt/unigrid_locale.qrc

TRANSLATIONS += src/qt/locale/unigrid_bg.ts \
                src/qt/locale/unigrid_de.ts \
                src/qt/locale/unigrid_en.ts \
                src/qt/locale/unigrid_es.ts \
                src/qt/locale/unigrid_fi.ts \
                src/qt/locale/unigrid_fr.ts \
                src/qt/locale/unigrid_it.ts \
                src/qt/locale/unigrid_ja.ts \
                src/qt/locale/unigrid_pl.ts \
                src/qt/locale/unigrid_pt.ts \
                src/qt/locale/unigrid_ru.ts \
                src/qt/locale/unigrid_sk.ts \
                src/qt/locale/unigrid_sv.ts \
                src/qt/locale/unigrid_vi.ts \
                src/qt/locale/unigrid_zh_CN.ts \
                src/qt/locale/unigrid_zh_TW.ts
