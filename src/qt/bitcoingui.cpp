                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("UNIGRID Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a UNIGRID address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and unigrid: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zUNIGRID"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About UNIGRID Core"), this);
    aboutAction->setStatusTip(tr("Show information about UNIGRID Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for UNIGRID"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your UNIGRID addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified UNIGRID addresses"));
    ...
    openAction->setStatusTip(tr("Open a UNIGRID: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the UNIGRID Core help message to get a list with possible UNIGRID command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("UNIGRID Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to UNIGRID network", "", count));
}
...
{
    QString strTitle = tr("UNIGRID Core"); // default title
