...
*Setup instructions for a gitian build of UNIGRID using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the UNIGRID
...
To build UNIGRID (for Linux, OSX and Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the unigrid repository.
...
```bash
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/unigrid/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/unigrid-crypto/unigrid
...
For example:
```bash
URL=https://github.com/crowning-/unigrid.git
COMMIT=b616fb8ef0d49a919b72b0388b091aaec5849b96
./bin/gbuild --commit unigrid=${COMMIT} --url unigrid=${URL} ../unigrid/contrib/gitian-descriptors/gitian-linux.yml
