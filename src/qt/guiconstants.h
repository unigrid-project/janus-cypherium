...
/* Unigrid GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "UNIGRID"
#define QAPP_ORG_DOMAIN "unigrid.org"
#define QAPP_APP_NAME_DEFAULT "UNIGRID-Qt"
#define QAPP_APP_NAME_TESTNET "UNIGRID-Qt-testnet"
