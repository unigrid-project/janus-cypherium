...
In order to support loading of multiple wallets in unigrid-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is unigrid.cpp.
...
Changes to unigrid.cpp
----------------------
unigrid.cpp is the entry point into unigrid-qt, and as such, will require some minor modifications to provide hooks for
