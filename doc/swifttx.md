...
This mechanism has been integrated into Bitcore-Node-UNIGRID which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/UNIGRID-Project/insight-api-unigrid#web-socket-api](https://github.com/UNIGRID-Project/insight-api-unigrid#web-socket-api) 
* API: [https://github.com/UNIGRID-Project/insight-api-unigrid#swifttx-transactions](https://github.com/UNIGRID-Project/insight-api-unigrid#swifttx-transactions) 
...
By default, the UNIGRID Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the UNIGRID Core daemon:
