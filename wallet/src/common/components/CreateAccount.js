...
import MnemonicButton from "./SelectionButton";
import './SetupStyles.css';

const CreateAccount = (props) => {
    const walletService = new WalletService();
    const enterWalletName = "Wallet Name";
        ...
        <div>
            ...
            <Expand open={showStart}>
                <div className="align--column--space-between">
                    <div className="fontSmallBold darkCopy">Create a new CPH wallet</div>
                    <div key={resetKey}>
                        ...
                        <div className="padding--top--five align--row--flexend">
                            <Button
                                ...
                                buttonStyle="btn--blue--solid">Continue</Button>
        ...
        return (
            <Expand open={showConfirm}>
                <div className="create--copy align--center">
                    <div className="darkCopy">Please click the mnemonics by original order</div>
                </div>
                ...
                <div className="padding--twenty align--row--flexend ">
                    <div className="padding--twenty">
                        <Button
                            ...
                            disabled={false}
                            buttonSize="btn--small"
                            buttonStyle="btn--blue--solid">Reset</Button>
                    </div>
                    <div className="padding--twenty">
                        <Button
                            handleClick={() => {
                            ...
                            buttonSize="btn--small"
                            buttonStyle="btn--blue--solid">Confirm</Button>
                    </div>
    ...
    function onConfirmPressed() {
        ...
        if (mnemonicDisplay === originalMnemonic) {
            ...
            let account = walletService.fromMnemonic(originalMnemonic).then((result) => {
                let account = result;
                let obj = {
                    account,
                    credentials
                }
                ipcRenderer.send('open-main-window', obj);
            });
        } else {
            setWarningMessage("mnemonic does not match please try again");
        }
    }
