...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_17_OLD_DEVFUND_ENFORCEMENT) r = SPORK_17_OLD_DEVFUND_ENFORCEMENT_DEFAULT;
        if (nSporkID == SPORK_18_BLACKLIST_BLOCK_REFERENCE) r = SPORK_18_BLACKLIST_BLOCK_REFERENCE_DEFAULT;
        if (nSporkID == SPORK_19_BLOCK_REWARDS_V2) r = SPORK_19_BLOCK_REWARDS_V2_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_17_OLD_DEVFUND_ENFORCEMENT") return SPORK_17_OLD_DEVFUND_ENFORCEMENT;
    if (strName == "SPORK_18_BLACKLIST_BLOCK_REFERENCE") return SPORK_18_BLACKLIST_BLOCK_REFERENCE;
    if (strName == "SPORK_19_BLOCK_REWARDS_V2") return SPORK_19_BLOCK_REWARDS_V2;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_17_OLD_DEVFUND_ENFORCEMENT) return "SPORK_17_OLD_DEVFUND_ENFORCEMENT";
    if (id == SPORK_18_BLACKLIST_BLOCK_REFERENCE) return "SPORK_18_BLACKLIST_BLOCK_REFERENCE";
    if (id == SPORK_19_BLOCK_REWARDS_V2) return "SPORK_19_BLOCK_REWARDS_V2";
