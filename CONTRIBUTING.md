Contributing to UNIGRID Core
============================

The UNIGRID Core project operates an open contributor model where anyone is
...
The following applies to code changes to the UNIGRID Core project, and is not to be
confused with overall UNIGRID Network Protocol consensus changes.

Whether a pull request is merged into UNIGRID Core rests with the project merge
...
Patches that change UNIGRID consensus rules are considerably more involved than
...
Where a patch set proposes to change the UNIGRID consensus, it must have been
...
The project leader is the release manager for each UNIGRID Core release.
