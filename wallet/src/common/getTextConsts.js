...
export const INFO_MESSAGE = gt.gettext("Unfortuantely the Janus wallet is no longer supported. Please use the Cypherium mobile wallet instead. You can export your private keys from the Janus wallet and import them into the Cypherium mobile wallet by going to the receive page and clicking 'Export Private Keys'.");
