...
/** Utility functions used by the UNIGRID Qt UI.
 */
namespace GUIUtil
{
...
// Render UNIGRID addresses in monospace font
...
// Parse "unigrid:" URI into recipient object, return true on successful parsing
